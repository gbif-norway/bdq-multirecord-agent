...
public class BDQRequest {
    ...
    public List<TestRequest> getTests() { return tests; }
    public void setTests(List<TestRequest> tests) { this.tests = tests; }
    ...
    public static class TestRequest {
        ...
        public List<List<String>> getTuples() { return tuples; }
        public void setTuples(List<List<String>> tuples) { this.tuples = tuples; }
    }
}
